...
namespace Intelipost.API.Business
{
    ...
    internal class ChangeDeliveryMethod
    {
        ...
        {
            return new Infrastructure.JsonRequest.Request<Model.ChangeDeliveryMethod>().Execute(Configure.PublicInstance.ApiKey, Configure.PublicInstance.ApiUrl, "shipment_order/change_delivery_method", "POST", request);
        }
    }
}