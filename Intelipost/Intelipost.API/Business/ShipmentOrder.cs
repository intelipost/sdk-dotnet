...
namespace Intelipost.API.Business
{
    ...
    internal class ShipmentOrder
    {
        ...
        {
            return new Infrastructure.JsonRequest.Request<Model.ShipmentOrder>().Execute(Configure.PublicInstance.ApiKey, Configure.PublicInstance.ApiUrl, "shipment_order", "POST", request, null, Configure.PublicInstance.Platform, Configure.PublicInstance.PlatformVersion, Configure.PublicInstance.Plugin, Configure.PublicInstance.PluginVersion);
        }
    }
}